json.extract! account, :id, :login, :has_sponsors_listing, :data, :created_at, :updated_at, :last_synced_at, :sponsors_count, :sponsorships_count, :active_sponsorships_count, :active_sponsors_count, :sponsor_profile, :minimum_sponsorship_amount
